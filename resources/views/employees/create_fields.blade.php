...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('nationality', $nationality, ['selected'=>'Filipino'], ['class' => 'form-control']) !!}
</div>

<!-- Religion Field -->
<div class="form-group col-sm-6">
    {!! Form::label('religion', 'Religion:') !!}
    {!! Form::select('religion', ['Christian' => 'Christian', 'Muslim' => 'Muslim', 'Roman Catholic' => 'Roman Catholic'], 'Roman Catholic', ['class' => 'form-control']) !!}
